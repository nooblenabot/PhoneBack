...
var ppcDF = "d/m/Y";
var ppcMN = new Array("Janvier","Février","Mars","Avril","Mai","Juin","Juillet","Août","Septembre","Octobre","Novembre","Décembre");
...
function makeCell(bgr,year,month,date) {
 ...
 var evt = "onMouseOver=\"this.style.backgroundColor=\'#00FF00\'\" onMouseOut=\"this.style.backgroundColor=\'"+bgr+"\'\" onMouseUp=\"selectDate("+param+")\" ";
